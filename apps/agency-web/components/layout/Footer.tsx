...
export default function Footer() {
  ...
  return (
    <footer className="w-full border-t border-white/5 bg-[#03060c] py-16 text-slate-400">
      <div className="mx-auto max-w-7xl px-6 sm:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          {/* Brand Info */}
          <div className="flex flex-col gap-4">
            <Link href="/" className="flex items-center gap-2.5">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-primary to-secondary font-display font-extrabold text-black text-lg">
                T
              </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-3.5 text-sm">
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:hello@trifusiondynamics.com" className="hover:text-white transition-colors">
        ...
        <div className="border-t border-white/5 pt-8 mt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500">
          <p>© {currentYear} Trifusion Dynamics. All rights reserved.</p>
          <p className="mt-2 sm:mt-0">Designed for fast-growing businesses.</p>
        </div>
      </div>
    </footer>
  );
